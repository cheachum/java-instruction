...
public class PrsConsoleApp {
	...
	public static void main(String[] args) {
		...
		User u1 = new User(1, "milliepuppin", "tatertot", "millie", "oestreicher", "612-555-6666", "milliepuppin@gmail",
				true, false);
		User u2 = new User(2, "osizzle", "pillow", "david", "oestreicher", "513-666-9999", "davidoestreicher@gmail",
				true, true);
